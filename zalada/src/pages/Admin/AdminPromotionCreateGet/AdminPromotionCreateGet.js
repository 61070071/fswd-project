...
import AddPromotionGet from "../../../components/AddPromotionGet/AddPromotionOnGet";
                    ...
                    <div className="w-100 box-add-product">
                        ...
                        <form>
                            <div className="w-100 d-flex align-items-center">
                                <div className="w-10 d-flex align-items-center py-1-v">
                                    <span className="color-second w-40 fs-0-8-v">BUY :</span>
                                    <input type="text" className="w-50 input-admin-promotion-sale" name="buy"/>
                                </div>
                                <div className="w-10 d-flex align-items-center py-1-v">
                                    <span className="color-second w-40 fs-0-8-v">GET :</span>
                                    <input type="text" className="w-60 input-admin-promotion-sale" name="get"/>
                                </div>
                        ...
                        <div className="w-100 box-list-promotion-onsale">
                            <div className="w-100 line-bottom-gray">
                                <div className="w-95 d-flex align-items-center">
                                    ...
                                    <div className="w-5 d-flex justify-content-center mx-auto">
                            ...
                            <div className="w-100 h-30-v">
                                {
                                    pro_get.map(function (element, index) {
                                        return <AddPromotionGet data={element}/>
                                    })
                                }
                            </div>
                        </div>
